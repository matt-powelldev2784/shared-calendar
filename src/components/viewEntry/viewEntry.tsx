  ...
  return (
    <Card>
      <CardHeader className="flex flex-col items-center">
        <Info className="inline-block h-12 w-12 text-white" />
        <CardTitle className="text-center">Calendar Entry Details</CardTitle>
      </CardHeader>

      <CardDescription className="text-center">View calendar entry detail below</CardDescription>

      <CardContent className="px-4">
        <div className="mb-2">
          <p className="pb-2 text-center text-lg font-bold">Entry Organisers</p>
            ...
            <ul className="flex flex-wrap items-center justify-center gap-2">
              {ownerEmails.map((email) => {
                return (
                  ...
                  >
                    <AtSign />
                    <p className="w-full truncate text-center text-xs text-black sm:text-sm">{email}</p>
                  </li>
                );
              })}
            </ul>
        ...
        <div className="border-secondary/25 mb-2 rounded-lg border-2 p-2">
          ...
          <p className="text-secondary text-lg">{entry.description ? entry.description : 'No description provided'}</p>
        </div>
        ...
        {pendingSubscribers.length > 0 && (
          <div className="mb-2 py-4">
            <p className="text-secondary/75 pb-2 text-center text-lg font-bold">Response Pending</p>
            ...
            <ul className="flex flex-wrap items-center justify-center gap-2">
              {pendingSubscribers.map((email) => {
                return (
                  ...
                  >
                    <AtSign />
                    <p className="text-secondary/75 w-full truncate text-center text-xs sm:text-sm">{email}</p>
                  </li>
                );
              })}
            </ul>
