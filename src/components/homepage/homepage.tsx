...
const Hero = () => {
  ...
  return (
    <article className="relative w-full">
      <div className="from-primary/10 via-primary/10 relative mx-4 flex flex-col items-center justify-start rounded-xl bg-gradient-to-b to-transparent md:mx-8">
        <p className="text-secondary mt-6 px-4 text-center text-2xl font-bold sm:text-3xl md:text-6xl md:leading-20 lg:text-6xl">
          Collaborative calendar
        </p>
        <p className="text-secondary px-4 text-center text-2xl font-bold sm:text-3xl md:text-6xl lg:text-6xl">
          management for <span className="text-primary">teams</span>
        </p>

        <p className="text-secondary mt-4 mb-4 w-full -translate-y-1.5 px-4 text-center text-sm leading-6 sm:-translate-y-1 sm:px-12 sm:text-sm sm:leading-7 md:mt-6 md:mb-8 md:px-16 md:text-base lg:w-[720px] lg:px-0">
